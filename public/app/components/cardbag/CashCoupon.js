...
var View = React.createClass({
  render: function(){
    ...
    return (
      <div className="f-view-container" id="view-my-cash-coupon">
        <Card.CashCoupon data={data} isOpen={+data.state < 2}/>
...
module.exports = React.createClass({
  ...
  getCoupon: function(){
    Weile
      .post('getMemberCashCoupon', {
        data: {
          memberCashCouponId: this.props.params.cardId  
        }
      })
      .then(function(data){
        var d = {}
        _.extend(d, data.data.cashCoupons)
        _.extend(d, data.data.memberCashCoupons)
      ...
      <div>
        <div id="second-header">
          <header>
            ...
            <span className="title f16">我的代金券</span>
          </header>
        </div>
        {_V} 
      </div>
